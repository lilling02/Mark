...
public class SqlOpt {
    ...
    public void insertUserDate(String username, String password){
        ContentValues values=new ContentValues();
        values.put("username",username);
        values.put("password",password);

        mOperate.insert("userlist",null,values);
    }
...
//        }
    ...
    public Cursor queryAllUser(){
        Log.i("TAG1", "queryAllUser: "+mOperate);
        return  mOperate.rawQuery("SELECT * FROM userlist", null);
